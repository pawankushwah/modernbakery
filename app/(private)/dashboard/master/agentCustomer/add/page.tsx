          ...
          <div className="bg-white rounded-2xl shadow divide-y divide-gray-200 mb-6">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <InputFields required label="Customer Type" name="customer_type" value={form.customer_type?.toString() ?? ""} onChange={handleChange} error={touched.customer_type && errors.customer_type} options={customerTypeOptions}/>
