...
const columns = [
    ...
    { key: "itemCode", label: "Product" },
    { key: "itemName", label: "Quantity", width: 250 },
    { key: "UOM", label: "UOM" },
...
export default function Order() {
    ...
    return (
        <>
            <div className="flex justify-between items-center mb-[20px] -z-20">
                ...
                <div className="flex flex-col md:flex-row justify-between">
                    <div className="flex flex-wrap gap-y-[20px] xl:flex-nowrap justify-between w-full">
                        <div className="flex flex-col space-y-[20px] text-primary-bold text-[14px] w-full xl:w-[312px] border-b-[1px] border-b-[#D5D7DA] pb-[20px] xl:pb-0 xl:border-0">
                            ...
                            <div className="flex flex-col space-y-[10px]">
                                ...
                                <span className="">
                                    Phone No.: 0068829546 <br />
                                    Email: thiele.hanspeter@email.com
                                </span>
                            </div>
                        </div>
                        <div className="flex flex-col space-y-[20px] text-primary-bold text-[14px] w-full xl:w-[312px]">
                            <span>To</span>
                            <div className="flex flex-col space-y-[10px]">
                                <span className="font-semibold">Hari K.</span>
                                <span className="">
                                    455, Shobe Lane, Colorado, Fort <br />
                                    Collins - 80524
                                </span>
                                <span className="">
                                    Phone No.: 0068829546 <br />
                    ...
                    <div className="flex md:justify-end space-y-[20px] text-primary-bold text-[14px] w-full xl:w-[312px] mr-[24px] border-t-[1px] border-[#D5D7DA] md:border-0 mt-[20px] md:mt-0 pt-[20px] md:pt-0">
                        <span className="flex flex-col space-y-[14px] w-fit">
                            <span>
                                Invoice Date:{" "}
                                <span className="font-bold">4 Oct, 2025</span>
                            </span>
                            <span>
                                Due Date:{" "}
                                <span className="font-bold">5 Oct, 2025</span>
                            </span>
                            <span>
                                Source: <span className="font-bold">Web</span>
                            </span>
                        </span>
                    </div>
                </div>
